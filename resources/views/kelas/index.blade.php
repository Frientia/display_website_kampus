...
<body>
    ...
    <div class="main-content">
        ...
        <div class="col-md-12">
            <div class="card">
                <h2 class="text-center">HALAMAN KELAS</h2>
            </div>
        </div>
                ...
                <div class="card w-100">
                    <div class="card-header">
                        ...
                        <a href="{{route('kelas.create')}}"><button class="btn btn-success">Tambah Kelas</button></a>
...
td form {
    margin: 0;
    display: inline-block; /* Pastikan form tidak meluas secara vertikal */
}
